    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 evento-item">
        <a href="#eventoModal1" class="evento-link" data-toggle="modal">
          ...
          <img src="<?php echo $fsConfig->getUrl() ?>pictures/buga-2.jpg" class="img-responsive" alt="">
      ...
      <div class="col-md-4 col-sm-6 evento-item">
        <a href="#eventoModal2" class="evento-link" data-toggle="modal">
          ...
          <img src="<?php echo $fsConfig->getUrl() ?>pictures/sitio1.jpg" class="img-responsive" alt="">
        </a>
        <div class="evento-caption">
      ...
      <div class="col-md-4 col-sm-6 evento-item">
        <a href="#eventoModal3" class="evento-link" data-toggle="modal">
          ...
          <img src="<?php echo $fsConfig->getUrl() ?>pictures/colegio.jpg" class="img-responsive" alt="">
        </a>
        <div class="evento-caption">
          <h4>Universidad</h4>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/buga-2.jpg" alt="">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/sitio1.jpg">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <p class="item-intro text-muted">Guadalajara de Buga</p>
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/colegio.jpg">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 evento-item">
        <a href="#eventoModal1" class="evento-link" data-toggle="modal">
          ...
          <img src="<?php echo $fsConfig->getUrl() ?>pictures/deporte.jpg" class="img-responsive" alt="">
      ...
      <div class="col-md-4 col-sm-6 evento-item">
        <a href="#eventoModal2" class="evento-link" data-toggle="modal">
          ...
          <img src="<?php echo $fsConfig->getUrl() ?>pictures/PROYECTO FUTBOL.jpg" class="img-responsive" alt="">
        </a>
        <div class="evento-caption">
      ...
      <div class="col-md-4 col-sm-6 evento-item">
        <a href="#eventoModal3" class="evento-link" data-toggle="modal">
          ...
          <img src="<?php echo $fsConfig->getUrl() ?>pictures/Screenshot.png" class="img-responsive" alt="">
        </a>
        <div class="evento-caption">
          <h4>Bombonera</h4>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/deporte.jpg" alt="">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            <h2>Estacion del ferrocarril</h2>
            <p class="item-intro text-muted">Guadalajara de Buga</p>
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/Estacion-ferrocarril-buga.jpg">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <h2>Universidad del valle</h2>
            <p class="item-intro text-muted">Guadalajara de Buga</p>
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/Antiguo Colegio Académico de Buga,.jpg">
            <p>Antiguo colegio Academico y actualmente la universidad del valle sede Buga.</p>
            <ul class="list-inline">
              <li>Lugar:carrera 13 # 6-23</li>
            </ul>
