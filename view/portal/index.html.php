    ...
    <as
      ...
      <div class="collapse navbar-collapse" id="click-movil">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li>
            <a class="page-scroll" href="<?php echo $fsConfig->getUrl() ?>index.php/sitios/sitios">Sitios</a>
          </li>
          ...
          <li>
            <a href="<?php echo $fsConfig->getUrl() ?>index.php/portal/nuevo">Registrate</a>
          </li>
...
<section class="slider-container">
  <ul id="slider" class="slider-wrapper">
    <li class="slide-current">
      <img src="<?php echo $fsConfig->getUrl() ?>pictures/fondo1-a.jpg" alt="Slider Imagen 1">
      <div class="caption">
    ...
    <li>
      <img src="<?php echo $fsConfig->getUrl() ?>pictures/fondo1-b.jpg" alt="Slider Imagen 1">
      <div class="caption">
    ...
    <li>
      <img src="<?php echo $fsConfig->getUrl() ?>pictures/fondo1-c.jpg" alt="Slider Imagen 1">
      <div class="caption">
    ...
    <li>
      <img src="<?php echo $fsConfig->getUrl() ?>pictures/fondo1-d.jpg" alt="Slider Imagen 1">
      <div class="caption">
  ...
  <div class="row">
    <section class="posts col-md-9">
      ...
      <article class="post clearfix">
        <a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/restaurantes" class="thumb pull-left">
          <img class="img-thumbnail" src="<?php echo $fsConfig->getUrl() ?>pictures/restaurante-paraisodelbuensazon5.jpg" alt="">
        </a>
        <h3><a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/restaurantes">Restaurantes</a></h3>
      ...
      <article class="post clearfix">
        <a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/fincasCampestres" class="thumb pull-left">
          <img class="img-thumbnail" src="<?php echo $fsConfig->getUrl() ?>pictures/fincacampestre-lamiranda.jpg" alt="">
        </a>
        <h3><a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/fincasCampestres">Fincas Campestres</a></h3>
        <p class="post-contenido text-justify">
      ...
      <article class="post clearfix">
        <a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/balnearios" class="thumb pull-left">
          <img class="img-thumbnail" src="<?php echo $fsConfig->getUrl() ?>pictures/balneario-lamaria.jpg" alt="">
        </a>
        <h3><a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/balnearios">Balnearios</a></h3>
        <p class="post-contenido text-justify">
      ...
      <article class="post clearfix">
        ...
        <p class="post-contenido text-justify">
          Dentro de sus <a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/restaurantes">Restaurantes</a>, 
          ...
          <a href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/balnearios">Balnearios</a> 
          de los corregimientos de la Maria, La Habana y Alaska, además de sus 
          <a class="link" href="<?php echo $fsConfig->getUrl() ?>index.php/categoria/fincasCampestres">
    ...
    <aside class="col-md-3 hidden-xs hidden-sm">
      ...
      <a href="#" class="list-group-item">
        <h4 class="list-group-item-heading">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis, ea.</h4>
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-6 evento-item">
      <a href="#eventoModal2" class="evento-link" data-toggle="modal">
        ...
        <img src="<?php echo $fsConfig->getUrl() ?>pictures/festival.jpg" class="img-responsive" alt="">
      </a>
      <div class="evento-caption">
    ...
    <div class="col-md-4 col-sm-6 evento-item">
      <a href="#eventoModal3" class="evento-link" data-toggle="modal">
        ...
        <img src="<?php echo $fsConfig->getUrl() ?>pictures/mama.jpg" class="img-responsive" alt="">
      </a>
      <div class="evento-caption">
    ...
    <div class="col-md-4 col-sm-6 evento-item">
      <a href="#eventoModal4" class="evento-link" data-toggle="modal">
        ...
        <img src="<?php echo $fsConfig->getUrl() ?>pictures/cuenta.jpg" class="img-responsive" alt="">
      </a>
      <div class="evento-caption">
    ...
    <div class="col-md-4 col-sm-6 evento-item">
      <a href="#eventoModal5" class="evento-link" data-toggle="modal">
        ...
        <img src="<?php echo $fsConfig->getUrl() ?>pictures/escritores.jpg" class="img-responsive" alt="">
      </a>
      <div class="evento-caption">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/teatro.jpg" alt="">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/festival.jpg">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/mama.jpg">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/cuenta.jpg">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="modal-body modal-color">
            ...
            <img class="img-responsive img-centered" src="<?php echo $fsConfig->getUrl() ?>pictures/escritores2.jpg">
