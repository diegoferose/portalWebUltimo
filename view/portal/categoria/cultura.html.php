      ...
      <div id="carousel-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo1-a.jpg' class="img-responsive">
          ...
          <div class="item">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo2-a.jpg' class="img-responsive">
            <div class="carousel-caption">
          ...
          <div class="item">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo3-a.jpg' class="img-responsive">
            <div class="carousel-caption">
              <h3> Tradiciones  </h3>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading">Arte y Tradicion</h2>
