      ...
      <div id="carousel-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo1-d.jpg' class="img-responsive">
          ...
          <div class="item">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo2-d.jpg' class="img-responsive">
            <div class="carousel-caption">
          ...
          <div class="item">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo3-d.jpg' class="img-responsive">
            <div class="carousel-caption">
