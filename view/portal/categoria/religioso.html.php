      ...
      <div id="carousel-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo1-c.jpg' class="img-responsive">
            <div class="carousel-caption">
              <h3>Parajes Paradisiacos</h3>
            </div>
          </div>

          <div class="item">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo2-c.jpg' class="img-responsive">
            <div class="carousel-caption">
          ...
          <div class="item">
            <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/fondo3-c.jpg' class="img-responsive">
            <div class="carousel-caption">
              <h3>Paisajes Deportivos</h3>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading">Religioso</h2>
          <h3 class="section-subheading text-muted">Ultimos Eventos</h3>
        </div>
      </div>
