  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="click-movil">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li>
          <a class="page-scroll" href="<?php echo $fsConfig->getUrl() ?>index.php/portal/categoria/categorias">Sitios</a>
        </li>
        ...
        <!--        iniciar sesion-->
       <li >
          <a href="#" ><b>Bienvenido Usuario</b> </a>
    ...
    <div id="carousel-1" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img id="banner" src='<?php echo $fsConfig->getUrl() ?>pictures/mosaicoSitios.jpg' class="img-responsive">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 evento-item">
        <a href="#eventoModal3" class="evento-link" data-toggle="modal">
          ...
          <img src="<?php echo $fsConfig->getUrl() ?>pictures/Antiguo Colegio Académico de Buga,.jpg" class="img-responsive" alt="">
        </a>
        <div class="evento-caption">
          <h4>Universidad</h4>
