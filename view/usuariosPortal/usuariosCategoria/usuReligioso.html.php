    ...
    <div id="carousel-1" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img id="banner" src='<?php echo URL ?>pictures/fondo1-c.jpg' class="img-responsive">
        ...
        <div class="item">
          <img id="banner" src='<?php echo URL ?>pictures/fondo2-c.jpg' class="img-responsive">
          <div class="carousel-caption">
        ...
        <div class="item">
          <img id="banner" src='<?php echo URL ?>pictures/fondo3-c.jpg' class="img-responsive">
          <div class="carousel-caption">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h2 style="font-family: fantasy"class="section-heading">Religioso</h2>
